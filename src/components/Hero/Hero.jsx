        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm ">
                “Savor the Royal Taste! 🍛<br />
              Delicious biryanis made with love, spices, and tradition. 
              From aromatic Dum Biryani to flavorful special blends — every bite is a celebration of flavor!”
              </p>
              <div>
